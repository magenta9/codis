...
CODIS_FE_BIN=$CODIS_BIN_DIR/fe
CODIS_FE_PID_FILE=$CODIS_BIN_DIR/fe.pid
CODIS_FE_ASSETS_DIR=$CODIS_BIN_DIR/assets

CODIS_FE_LOG_FILE=$CODIS_LOG_DIR/fe.log
CODIS_FE_DAEMON_FILE=$CODIS_LOG_DIR/fe.out

COORDINATOR_NAME="filesystem"
COORDINATOR_ADDR="/tmp/cachecluster"
...
stop)
    ...
    then
      echo "no fe to stop (could not find file $CODIS_FE_PID_FILE)"
    else
